...
X predstavlja bilo koji broj (moze ici u beskonacnost), a taj broj ne
mora postojati (može biti samo iprezime@sum.ba).
Od korisnika zatražiti unos maila i eduid te ispisati uspješnost.
'''

import re

email_adresa = input("Unesite e-mail (ime.prezime@fpmoz.sum.ba): ")
...
if re.match(regex, email_adresa):
