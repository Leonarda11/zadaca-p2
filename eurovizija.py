...
Nasumično odabrati 26 država koje će se natjecati u finalu i dodati
ih u novu listu rječnika oblika:
{
  "drzava": "Croatia",
...
Nakon izbora finalista, potrebno je simulirati
glasanje. Svaka država s popisa 37 drzava moze glasati.
...
generator=random.sample(countries, 26)
finalisti=[]

for drzava, izvodjac, pjesma in generator:
    rijecnik_elemenata={
        "drzava":drzava,
        "izvodjac":izvodjac,
        "pjesma":pjesma
